...
<div class="form-group">
        <form action="" method="post">
            <div class="form-group w-50 mt-2 float-start">
                <label class="mb-1" for="">Tanggal Awal</label>
                <input type="date" name="tawal" required class="form-control mt-2">
            </div>

            <div class="form-group w-50 mt-2 float-end">
                <label class="mb-1" for="">Tanggal Akhir</label>
                <input type="date" name="takhir" required class="form-control mt-2">
            </div>

            <div>
                <input type="submit" name="simpan" value="Cari" class="btn btn-primary mt-2">
            </div>
        </form>
    </div>
