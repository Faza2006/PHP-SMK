...
<?php 
    ...
    function daftar(){
        ...
        foreach ($_SESSION as $key => $value) {
            if ($key<>'pelanggan' && $key<>'idpelanggan' && $key<>'user' && $key<>'level' && $key<>'iduser') {
                ...
                foreach ($row as $r) {
                    ...
                    echo '<td><a class="btn btn-outline-danger" href="?f=home&m=beli&hapus='.$r['idmenu'].'">hapus</a></td>';
                    echo '</tr>';
        ...
        echo '<tr>
            <td colspan=4><h3>Total Harga : </h3></td>
            <td><h3>'.$total.'</h3></td>
        </tr>';
...
<a class="btn btn-outline-success" href="?f=home&m=checkout&total=<?php echo $total?>" role="button">CHECKOUT</a>
