...
<body>
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="float-end mt-4 mr-4"><a class="btn btn-outline-warning" href="?log=logout"> logout</a></div>
            <div class="float-end mt-4 me-4 btn btn-outline-danger">User : <a href="?f=user&m=updateuser&id=<?php echo $_SESSION['iduser'] ?>"><?php echo $_SESSION['user'] ?> </a> </div>
